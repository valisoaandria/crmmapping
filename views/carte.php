...
?>
    ...
    <div id="container">
      ...
      <div id='alaInfo' style="position: absolute;bottom: 10px; right: 10px; background-color: white; padding: 10px; border: 1px solid #ccc; z-index: 1000; max-width: 300px;"><i class="fas fa-info-circle"></i></div>
     <div id="map"></div>
    <!--script src="bootleaf/L.Control.Layers.Tree.js"></script-->
     </div>
