    ...
    if (map.hasLayer(balisesLayer)) {
      if (map.getBounds().contains(layer.getLatLng())) {
        ...
        $("#feature-list tbody").append(
          ...
          '<i class="fas fa-store-alt feature-icon"></i> ' + properties.name.toUpperCase() +
          '</strong><br>' +
          '<i class="fa fa-key feature-key-icon"></i>' +
          '<strong class="feature-tag">' + properties.tags + '</strong><br>' +
          '<strong class="feature-accuracy">' +
          '<i class="fas fa-home feature-accuracy-icon"></i> Accuracy ' + properties.accuracy +
          '</strong><br>' +
          '<strong class="feature-provider">' +
          '<i class="fas fa-map-marker-alt feature-provider-icon"></i> Provider ' + properties.provider +
          '</strong>' +
          '</td>' +
          '</tr>'
        );
...
var balises = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    ...
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "img/emplacement_milay.png",
        iconSize: [28, 30],
        popupAnchor: [0, -25]
      }),
      riseOnHover: true
...
var fokontanyCible = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    L.marker(coords, { icon: L.divIcon({ className: 'fokontany-label', html: feature.properties.fokontany, iconSize: [130, 40] }) }).addTo(fokontanyCibleLayer);
...
var rootUrl_alaotraFO = 'http://192.168.1.241:8080/geoserver/cecam/ows';
...
var rootUrl_fo = 'http://192.168.1.241:8080/geoserver/cecam/ows';
...
var rootUrl_anjezika = 'http://192.168.1.241:8080/geoserver/cecam/ows';
...
var groupedOverlays = {
  "Andavamamba anjezika": {
    //"<img src='img/polygone.png' width='24' height='24'>&nbsp;Fokontany": anjezikaLayer,
    "<img src='img/limite_sect.png' width='15' height='15'>&nbsp;Limite secteur": sect_anjezika,
    "<img src='img/limite_fkt.png' width='15' height='15'>&nbsp;Limite Fokontany": andavamamba_anjezika,
    "<img src='img/ruelle.png' width='15' height='15'>&nbsp;Ruelle": ruelle_anjezika,
    "<img src='img/OcSol.png' width='15' height='15'>&nbsp;OcSol": ocsol_anjezika,
    "<img src='img/batiment.png' width='15' height='15'>&nbsp;Batiment": batiment_anjezika,
  },
  "Risques": {
    "<img src='img/inondation.png' width='15' height='15'>&nbsp;Inondation": inondation_anjezika,
    "<img src='img/Incendie.jpg' width='15' height='15'>&nbsp;Incendie": incendie_anjezika,
    "<img src='img/Epidemie.jpg' width='15' height='15'>&nbsp;Epidemie": epidemie_anjezika,
  },
  "Points d'interet": {
    "<img src='img/balises.jpg' width='15' height='15'>&nbsp;Balises": balisesLayer,
    "<img src='img/drapeau-rouge.png' width='15' height='15'>&nbsp;Drapeaux": csoLayer,
    "<img src='img/quartier.png' width='15' height='15'>&nbsp;Majunga": vakLayer,
  },
  "Fokontany": {
    "<img src='img/fktCible.png' width='15' height='15'>&nbsp;Fkt Majunga": region,
    "<img src='img/fktCible.png' width='15' height='15'>&nbsp;Fkt Cible": fokontanyCibleLayer,
  },
};
