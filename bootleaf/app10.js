var map, featureList, regionSearch = [], pdvSearch = [], routeSearch = [], districtSearch = [], hostoSearch = [];
...
var hosto = L.tileLayer.wms('http://localhost:8080/geoserver/RN1/wms', {
  attribution: '(C) OMA 2017',
  layers: 'RN1:hopital',
  format: 'image/png',
  pointToLayer: function (feature, latlng) {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Ville</th><td>" + feature.properties.nom + "</td></tr>" + "<tr><th>Nom</th><td>" + feature.properties.adresse + "</td></tr>" + "<tr><th>Type</th><td>" + feature.properties.horaires + "</td></tr>" + "<tr><th>Adresse</th><td>" + feature.properties.contact + "</td></tr>" + "<table>";
      layer.on({
        click: function (e) {
          $("#feature-title").html("<h3 class=''><img src='bootleaf/ho.png' width='24' height='28'>&nbsp;Point de Vente</h3>");
          $("#feature-info").html(content);
          $("#featureModal").modal("show");
          highlight.clearLayers().addLayer(L.circleMarker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], highlightStyle));
        }
...
var groupedOverlays = {
  "Points d'interet": {
    ...
    "<img src='bootleaf/ho.png' width='24' height='24'>&nbsp;Hopital": hosto,
  },
  "Reference": {
    "Region": region,
    "district": district,
